...
/*
 * 合并对象，把n对象合并到o对象，最终返回o
 * */
baseUtil.assign=function(o,n){
    if( Object.assign){
        Object.assign(o,n);
    }else {
        for (var p in n){
...
* 判断元素elem是否包含有样式cls
* */
baseUtil.hasClass=function(elem, cls) {
    cls = cls || '';
 ...
 * 为元素elem添加样式cls
 * */
baseUtil.addClass=function(elem, cls) {
    if (!baseUtil.hasClass(elem, cls)) {
 ...
 * 为元素elem移除样式cls
 * */
baseUtil.removeClass=function(elem, cls) {
    if (baseUtil.hasClass(elem, cls)) {    
