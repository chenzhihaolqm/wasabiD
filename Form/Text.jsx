...
var Text=React.createClass({
    ...
    propTypes: {
        ...
        iconClass:React.PropTypes.string,//Icon图标样式
        ...
        clickIcon:React.PropTypes.func,//点击Icon事件
        iconTip:React.PropTypes.string,//Icon鼠标悬浮显示title
    ...
    changeHandler:function(event) {
        if (this.validateInput==true) {//输入有效的时候
            if((this.props.type=="integer"||this.props.type=="number")) {
                ...
                /*
                *modify by liangjiaxuan
                * 正整数修改为如果发现非正整数设置为空
                 *  */
                if(this.props.type=="integer"&&!/\d/.test(event.target.value)){
                    event.target.value="";
                }
    ...
    clickIcon:function(event) {//点击Icon事件
         this.props.clickIcon && this.props.clickIcon(event); 
    },
    ...
    render:function() {
        ...
        return (<div className={componentClassName+this.state.validateClass} onPaste={this.onPaste} style={ controlStyle}>
                ...
                <div className={ "wasabi-form-group-body"} style={{width:!this.props.label?"100%":null}}>
                    ...
                    <i className={"wasabi-icon "+ this.props.iconClass} title={this.props.iconTip} onClick={this.clickIcon} style={{display:(this.props.iconClass?"inline-block":"none")}}></i>
