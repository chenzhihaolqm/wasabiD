...
let DatePicker=React.createClass({
    ...
    renderDateRange:function() {
        ...
        return <DateRange ref="combobox"  name={this.props.name} firstDate={firstDate} secondDate={secondDate} onBeforeSelect={this.props.onBeforeSelect}  onSelect={this.onSelect}></DateRange>
    },
    render:function() {
        let control = null;
