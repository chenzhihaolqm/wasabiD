...
let DateRange=React.createClass({
    ...
    onSelectHandler:function() {
        ...
        let beforeFlag = this.props.onBeforeSelect?this.props.onBeforeSelect(firstDate,secondDate,this.refs.errTipContainer):true;  //前置校验
        if(!beforeFlag){
            return false; //前置校验不通过
        }
    ...
    render:function() {
         return (<div>
             <div className="ok">
                 <span style={{ color:"#de2c3b",padding:"0 5px"}} ref="errTipContainer"></span>
