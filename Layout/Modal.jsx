    ...
    render() {
        ...
        if (this.props.showOK == true || this.props.showCancel == true) {
            if (this.props.showOK) {
                buttons.push(
                    <Button  title={this.props.submitTitle} delay={this.props.delayBtnTime} key="ok" theme="green" onClick={this.OKHandler}
                            style={{width: 60, height: 30}}></Button>
                )
            }
            if (this.props.showCancel) {
                buttons.push(
                    <Button title={this.props.closeTitle} key="cancel" theme="cancel" onClick={this.cancelHandler}
...
Modal.propTypes={
    ...
    delayBtnTime:React.PropTypes.number,
}
