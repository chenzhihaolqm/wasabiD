...
let  Button  = React.createClass({
    ...
    propTypes: {
        ...
        onMouseEnter:React.PropTypes.func,//鼠标悬浮进入事件
        onMouseLeave:React.PropTypes.func,//鼠标悬浮离开事件
    ...
    onMouseEnter:function(event){
        this.props.onMouseEnter && this.props.onMouseEnter(this.props.name,this.props.title,event);
    },
    onMouseLeave:function(event){
    this.props.onMouseLeave && this.props.onMouseLeave(this.props.name,this.props.title,event);
},
    render: function () {
        ...
        return (
            <button {...props} onClick={this.clickHandler} onMouseEnter={this.onMouseEnter} onMouseLeave={this.onMouseLeave} type="button">{this.state.title}</button>
        )
    }
